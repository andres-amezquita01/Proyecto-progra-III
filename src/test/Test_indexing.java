...
/**
 * Prueba el correcto indexamiento a traves de los nodos
 * de un arbol binario que esta almacenado en un 
 * archivo binario en persistencia.
 * @author Andres Amezquita , Darwind Vargas, Felipe Moreno
 *
 */
public class Test_indexing {
	public static void main(String[] args) throws Exception {
		 ComplementDatas complementDatas = new ComplementDatas();

		MyBinarySearchTree<String> myBinarySearchTree = new MyBinarySearchTree<>("resources/out/test/indexing.1", new Comparator<String>() {
			@Override
