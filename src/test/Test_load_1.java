 ...
 * con 10.000 registros de personas
 */
public class Test_load_1 {
	public static void main(String[] args) throws Exception {
		...
		MyMasterPersonFile myMasterPersonFileTest = new MyMasterPersonFile("resources/out/loadTest/loadMaster.test");
		MyBinarySearchTree<String> myBinarySearchTree = new MyBinarySearchTree<>("resources/out/loadTest/loadTree.test", new Comparator<String>() {
			@Override
		...
		ArrayList<Person> listPersonRandom = creatorRandomDatas.generateDatas(10000);
		...
		//tiempo medio 61774 milisegundos
	}
}
